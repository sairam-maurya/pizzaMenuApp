        ...
        <main className="menu">
            ...
            {numPizzas > 0 ? (
                <>
                    ...
                    <p>Authentic Italian cuisine. 6 creative dishes to choose from. All from our stone even, all organic, all deliciou</p>
                    <ul ul className="pizzas">
                        {pizzaData.map((pizza) => (
            ...
            <Pizza name="Pizza Fungi " ingredients="Tomato, mozarella, mushrooms, and onion" photoName="pizzas/funghi.jpg" />
